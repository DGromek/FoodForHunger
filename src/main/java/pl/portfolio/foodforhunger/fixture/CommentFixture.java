...
public class CommentFixture {
    ...
    public void initData() {
        ...
        comment3.setCreated(LocalDateTime.now().minusMonths(9).minusDays(7));
        ...
        comment4.setCreated(LocalDateTime.now().minusMonths(9).minusDays(7));
        ...
        comment5.setCreated(LocalDateTime.now().minusMonths(9).minusDays(7));
