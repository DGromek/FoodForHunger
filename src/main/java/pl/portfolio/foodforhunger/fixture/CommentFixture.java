...
public class CommentFixture {
    ...
    public void initData() {
        ...
        comment1.setCreated(LocalDate.now().minusMonths(4).minusDays(3));
        ...
        comment2.setCreated(LocalDate.now().minusMonths(9).minusDays(7));
        ...
        comment3.setCreated(LocalDate.now().minusMonths(11).minusDays(4));
        ...
        comment4.setCreated(LocalDate.now().minusMonths(4).minusDays(6));
        ...
        comment5.setCreated(LocalDate.now().minusMonths(1).minusDays(11));
