...
<body onload="profileDishPagination(0); profileCommentPagination(0)">

<%@ include file="../core/header.jsp" %>

<span class="d-none" id="logged-user-username">${loggedUser}</span>
            ...
            <div class="modal-body">
                ...
                <form>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="add-edit-rating">
                        ...
                        <small class="error-message form-text" id="rating-error"></small>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Treść:</label>
                        <textarea class="form-control" id="add-edit-content"></textarea>
                        <small class="error-message form-text" id="content-error"></small>
                    </div>
                </form>
                <div class="d-flex justify-content-end">
                    <button class="btn btn-primary" data-dismiss="modal" aria-label="Close">Anuluj</button>
                    <button onclick="saveComment('POST')" class="btn btn-success ml-1" id="add-button">Zapisz</button>
                    <button class="btn btn-success ml-1" id="update-button">Zapisz</button>
                </div>
            </div>
